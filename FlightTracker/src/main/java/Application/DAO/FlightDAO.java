...
public class FlightDAO {
    ...
    public List<Flight> getAllFlights(){
        ...
        try {
            ...
            String sql = "SELECT * FROM flight";  // I worked here
    ...
    public Flight getFlightById(int id){
        ...
        try {
            ...
            preparedStatement.setInt(1, id);                    // i worked here
            ResultSet rs = preparedStatement.executeQuery();
            while(rs.next()){
                Flight flight = new Flight(rs.getInt("flight_id"), rs.getString("departure_city"),
                        rs.getString("arrival_city"));
    ...
    public Flight insertFlight(Flight flight){
        ...
        try {
            ...
            //write preparedStatement's setString and setInt methods here.
            preparedStatement.setString(1,flight.departure_city);           //I worked here
            preparedStatement.setString(2,flight.arrival_city);             //I worked here
