...
public class BookDAO {
    ...
    public List<Book> getAllBooks(){
        ...
        try {
            ...
            String sql = "SELECT * FROM book; ";                                    //add by me
    ...
    public Book getBookByIsbn(int isbn){
        ...
        try {
            //Write SQL logic here
            String sql = "SELECT * FROM book where isbn=? ; ";                          //add by me
            PreparedStatement preparedStatement = connection.prepareStatement(sql);

            //write preparedStatement's setInt method here.
            preparedStatement.setInt(1, isbn);                           //add by me
            ResultSet rs = preparedStatement.executeQuery();
            while(rs.next()){
                Book book = new Book(rs.getInt("isbn"),
                        rs.getInt("author_id"),
    ...
    public Book insertBook(Book book){
        ...
        try {
            ...
            preparedStatement.setInt(1,book.getIsbn() );                           //add by me
            preparedStatement.setInt(2, book.getAuthor_id());                           //add by me
            preparedStatement.setString(3, book.getTitle());                           //add by me
            preparedStatement.setInt(4, book.getCopies_available());                           //add by me
